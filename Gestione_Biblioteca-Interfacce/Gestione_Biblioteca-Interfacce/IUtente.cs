...
namespace Gestione_Biblioteca_Interfacce
{
    public interface IUtente
    {
        ...
        // 4 - non possono essere dichiarati metodi statici, sono tutti metodi di istanza quelli definiti in una interface
        // 5 - come per gli abstract, le classi che erediteranno l'interfaccia dovranno implementare tutte le proprietà ed i metodi definiti nella interfaccia
